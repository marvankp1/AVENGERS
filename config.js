...
module.exports = {
    ...
    SESSION: process.env.RAGANORK_CODE === undefined ? '' : process.env.AVENGERS_CODE,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AFN: process.env.ALL_CAPTION === undefined ? '*AͥVͭEᷤNGͫEͤR BᷟOͣTᷢ2ͮ.ͣ0ᷡ*' : process.env.ALL_CAPTION,
    ...
    AFNN: process.env.TAG_REPLY === undefined ? '917591942952@s.whatsapp.net' : process.env.TAG_REPLY,
    NBSK: process.env.ALL_NUMBER === undefined ? '917591942952' : process.env.ALL_NUMBER,
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    ADDMSG: process.env.ADD_MESSAGE === undefined ? 'default' : process.env.ADD_MESSAGE,
    MUTEMSG: process.env.MUTE_MESSAGE === undefined ? 'default' : process.env.MUTE_MESSAGE,
    PLK: process.env.OWNER_NAME === undefined ? 'MͥAͭRᷤVᷟAͤN' : process.env.OWNER_NAME,
    ...
    SUPPORT: "917591942952-1632403322",
